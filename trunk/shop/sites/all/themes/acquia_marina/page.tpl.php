      ...
      <div id="header">
        <div id="header-wrapper" class="clearfix">
          ...
          <div id="header-first">
            <?php if ($logo): ?> 
            <div id="logo">
              <a href="<?php print $base_path ?>" title="<?php print t('Home') ?>"><img src="<?php print $logo ?>" alt="<?php print t('Home') ?>" /></a><br><b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;For Free!</b></br>
            </div>
            <?php endif; ?>
            <?php if ($site_name): ?>
          ...
          <div id="content-wrapper">
            ...
            <div id="content">
              ...
              <div id="content-tabs">
				...
				$prodnode = node_load(arg(1));
				if($prodnode->field_isactive[0]['value'] != 0){print $tabs;}} ?>
              </div>
              <?php endif; ?>
